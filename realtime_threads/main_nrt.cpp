...
void *nrt(void * arg){
    ...
    struct timespec t_start, t_now, t_next, t_period, t_result,t_overflow;
    ...
    // Compute the time for the execution of this task*/
    t_period.tv_sec = 0;
...
//        TIMESPEC_INCREMENT ( t_next, t_period );
        ...
        if(loop_count%1000==0){
            ...
            PLOGI << "NRT Clock: " << (double) (timespec_to_nsec(&t_result)/1e9) << endl;
